      ...
      <main className="flex flex-col gap-4 p-4 md:gap-8 md:p-10">
        <section>
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <CardTitle className="text-sm font-medium">Homework Assignment</CardTitle>
                <div className="flex items-center gap-2">
                  <Button size="icon" variant="outline">
                    <FileEditIcon className="h-4 w-4" />
                    <span className="sr-only">Edit</span>
        ...
        <section>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Input className="w-full max-w-[300px]" placeholder="Search violations..." type="search" />
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-[200px]">
                  ...
                  <DropdownMenuCheckboxItem>Violation Type</DropdownMenuCheckboxItem>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>Using unauthorized materials</TableCell>
                  <TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>Suspicious eye movements</TableCell>
                  <TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>Talking to another person</TableCell>
                  <TableCell>
                ...
                <TableRow>
                  <TableCell>Participation Quiz</TableCell>
                  <TableCell>Sarah Lee</TableCell>
                  <TableCell>Accessing unauthorized website</TableCell>
                  <TableCell>
                    <Badge variant="red">High</Badge>
                  </TableCell>
                  <TableCell>
